			...
			for (int xx = 0; xx < map.getWidth(); xx++) {
				for (int yy = 0; yy < map.getHeight(); yy++) {
					...
					if (pixelAtual == 0xFF000000) {
						...
						// Cerejas
						Cereja cereja = new Cereja(xx * 16, yy * 16, 16, 16, 0, Entity.CEREJA_SPRITE);
						Game.entities.add(cereja);
						Game.frutas_contagens++;
					}
				}
			}
		} catch (IOException e) {
